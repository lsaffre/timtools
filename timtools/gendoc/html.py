    ...
    def report(self, rpt):
        ...
        header = [
            TH(col.getLabel(),
               ...
               valign=col.datatype.valign) for col in rpt.columns
        ]
        t = TABLE()
        cols = []
        ...
        for row in rpt.rows():
            line = [
                TD(s, align=col.datatype.halign, valign=col.datatype.valign)
...
class Document(Story):
    ...
    def __init__(self, title="Untitled", date=None, stylesheet=None):
