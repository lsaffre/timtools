...
def exec_exec(name, arguments, options, content, lineno, content_offset,
    ...
    _stdout = sys.stdout
    sys.stdout = StringIO()
    exec(text, _namespace, _namespace)
    #try:
    ...
    insert_lines = statemachine.string2lines(stdout_text, convert_whitespace=1)
...
def reSTify(s, source_path=None, namespace=None, settings=None):
