...
from timtools.sdoc.lists import NumberedListStyle
...
def p(*args, **kw):
    return document.p(*args, **kw)


def h1(*args, **kw):
    return document.h1(*args, **kw)


def h2(*args, **kw):
    return document.h2(*args, **kw)


def h3(*args, **kw):
    return document.h3(*args, **kw)


def pre(*args, **kw):
    return document.pre(*args, **kw)


def memo(*args, **kw):
    return document.memo(*args, **kw)


def img(*args, **kw):
    return document.img(*args, **kw)


def barcode(*args, **kw):
    return document.barcode(*args, **kw)
...
def beginTable(*args, **kw):
    return document.beginTable(*args, **kw)


def endTable(*args, **kw):
    return document.endTable(*args, **kw)


def addColumn(*args, **kw):
    return document.addColumn(*args, **kw)


def beginCell(*args, **kw):
    return document.beginCell(*args, **kw)


def endCell(*args, **kw):
    return document.endCell(*args, **kw)


def beginRow(*args, **kw):
    return document.beginRow(*args, **kw)


def endRow(*args, **kw):
    return document.endRow(*args, **kw)


def restartRow(*args, **kw):
    return document.restartRow(*args, **kw)


def cell(*args, **kw):
    return document.cell(*args, **kw)


def tr(*args, **kw):
    return document.tr(*args, **kw)


def formatCell(*args, **kw):
    return document.formatCell(*args, **kw)


def formatRow(*args, **kw):
    return document.formatRow(*args, **kw)


def formatColumn(*args, **kw):
    return document.formatColumn(*args, **kw)


def formatTable(*args, **kw):
    return document.formatTable(*args, **kw)


def formatHeader(*args, **kw):
    return document.formatHeader(*args, **kw)


def beginList(*args, **kw):
    return document.beginList(*args, **kw)


def endList(*args, **kw):
    return document.endList(*args, **kw)


def li(*args, **kw):
    return document.li(*args, **kw)


def beginDocument(outputfile, renderer, source=None):
    global document
    global stylesheet
